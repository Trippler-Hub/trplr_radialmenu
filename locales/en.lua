local Translations = {
    title = {
        ...
        sell_secret = "Sell Secretly",
        house_interact = "House Interactions",
        house_keys = "Give House Keys",
        house_remove = "Remove House Keys",
        house_toggle = "Toggle Doorlock",
        house_decorate = "Decorate House",
        house_locations = "Interaction Locations",
        house_stash = "Set Stash",
        house_wardrobe = "Set Wardrobe",
        house_logout = "Set Logout",
        ambulance_check = "Check Health Status",
        ambulance_revive = "Revive",
        ambulance_heal = "Heal wounds",
        ambulance_emergency = "Emergency button",
        ambulance_escort = "Escort",
        ambulance_stretcher = "Stretcher",
        ambulance_spawn = "Spawn Stretcher",
        ambulance_remove = "Remove Stretcher",
        taxi_toggle_showing = "Show/Hide Meter",
        taxi_toggle_starting = "Start/Stop Meter",
        taxi_mission = "NPC Mission",
        tow_mission = "Toggle NPC",
        tow_vehicle = "Tow vehicle",
        mechanic_vehicle = "Tow vehicle",
        police_emergency = "Emergency",
        police_dispatch = "Dispatch",
        police_interact = "Police",
        police_revoke = "Revoke Driving License",
        police_fine = "Fine",
        police_jail = "Jail",
        police_reset = "Reset House Keys",
        police_objects = "Objects",
        police_cone = "Cone",
        police_gate = "Gate",
        police_speed = "Speed Limit Sign",
        police_tent = "Tent",
        police_lighting = "Lighting",
        police_spike = "Spike Strips",
        police_remove = "Remove object",
        police_mdt = "MDT",
        police_radio = "Radio",
        police_radar = "Radar",
        police_search= "Search",
        police_plist = "Police List",
        hotdog_toggle = "Toggle sell",
    },
    error = {
